view: fotc_dp_ce_gl_detail_output_previous_period_cmb {
  required_access_grants: [explorer_security_cmb_1]
  label: "GL Detail Output Previous Period"
  derived_table: {
    sql: SELECT * FROM @{server_name_fire}.@{schema_name}.FOTC_DP_CE_GL_DETAIL_OUTPUT_PREVIOUS_PERIOD CY
           JOIN (select * from  @{server_name_fire}.@{schema_name}.FOTC_RD_BFA_MI_FLAT_DIMENSIONS  where dimension ='Global_Standard_Segment' and dimension_tree_id ='1'  and level_1='GSS10002') SEGMENT
